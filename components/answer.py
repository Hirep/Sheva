from parser_diagram import find_lang_part, load_dict
...
def get_answer(phrase, question):
    ...
    q2_transformed, start, tt = find_lang_part(question)
    phrase_trans, ph_st, tt2 = find_lang_part(phrase)
